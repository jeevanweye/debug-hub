...
//         platform enum ('android', 'ios') NOT NULL,
//         timestamp DATETIME DEFAULT CURRENT_TIMESTAMP
//         tableType TEXT default 'network'
//       )
//     ''');
//
//     await db.execute('''
...
//         platform enum ('android', 'ios') NOT NULL,
//         timestamp DATETIME DEFAULT CURRENT_TIMESTAMP
//         tableType TEXT default 'notification'
//       )
//     ''');
//
//     await db.execute('''
...
//         platform enum ('android', 'ios') NOT NULL,
//         timestamp DATETIME DEFAULT CURRENT_TIMESTAMP
//         tableType TEXT default 'nonFatal'
//       )
//     ''');
//
//     await db.execute('''
